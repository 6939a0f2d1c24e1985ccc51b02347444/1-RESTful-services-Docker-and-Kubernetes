...
class Student(Model):
    ...
    """
    def __init__(self, first_name: str, last_name: str, student_id: Optional[int] = None, grade_records: List[GradeRecord]=[]):  # noqa: E501
    ...
    def from_dict(cls, dikt) -> 'Student':
        ...
        if result is None:
            raise ValueError("Failed to deserialize Student from dict")
        return result
